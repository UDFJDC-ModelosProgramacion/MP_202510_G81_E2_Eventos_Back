...
//        newLocation.setEvent(sampleEvent);
//
...
public class LocationServiceTest {
    ...
    void setUp() {
        ...
        // Establecer ambos lados de la relación
        sampleLocation.setEvent(sampleEvent);
        sampleEvent.setLocation(sampleLocation);
    ...
    @Test
    void testGetLocationByEvent() throws EntityNotFoundException {
        LocationEntity location = locationService.getLocationByEvent(sampleEvent.getId());
        assertNotNull(location);
        assertEquals(sampleLocation.getId(), location.getId());
    }
}
